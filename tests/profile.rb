...
#  attr_accessible :first_name, :last_name, :image_url, :image_url_medium,    :image_url_small, :birthday, :gender, :bio, :location, :searchable, :date, :tag_string

#  belongs_to :person
#  before_validation do    self.tag_string = self.tag_string.split[0..4].join(' ')  end
#  before_save do    self.build_tags    self.construct_full_name  end
